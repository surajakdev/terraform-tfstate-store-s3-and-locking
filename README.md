![statefile_stored_in_s3](https://github.com/user-attachments/assets/a9c55683-2489-488b-a3c4-49eda269af27)# EC2 Setup with Terraform and automated tfstate file Storage in s3 and DynamoDB Locking
